...
function getConnection() {
	...
	global $db_blank_db_Url, $db_blank_db_User, $db_blank_db_Pass, $db_blank_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_blank_db_Url.";dbname=".$db_blank_db_DbName, $db_blank_db_User, $db_blank_db_Pass);
